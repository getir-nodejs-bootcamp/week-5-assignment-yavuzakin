...
const { createUser, createAdminUser, userLogin, resetPasswordValidation } = require("../validations/Users");
...
router.route("/reset-password").post(validate(resetPasswordValidation, "body"), resetPassword);
